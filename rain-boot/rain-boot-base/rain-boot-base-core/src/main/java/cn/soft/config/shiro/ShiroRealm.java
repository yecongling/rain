...
import cn.soft.config.mybatis.TenantContext;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    public LoginUser checkUserTokenIsEffect(String token) throws AuthenticationException {
        ...
        if (ConvertUtils.isNotEmpty(userTenantIds)) {
            ...
            if (ConvertUtils.isNotEmpty(contextTenantId) && !"0".equals(contextTenantId)) {
                if (!String.join(",", userTenantIds).contains(contextTenantId)) {
